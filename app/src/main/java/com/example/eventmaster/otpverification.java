            ...
            currentUser.linkWithCredential(credential)
                    .addOnCompleteListener(this, task -> {
                        if (task.isSuccessful()) {
                            Toast.makeText(context, "Phone number linked successfully", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(context, "Error linking phone number: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
